                    ...
                    <div className="flex flex-wrap justify-evenly items-center -m-4">
                        <div className="lg:w-1/3 h-1/2 member lg:mb-0 mb-6 p-6">
                            <div className="h-full text-center">
                                ...
                                <p style={{ color: mode === 'dark' ? 'white' : '' }} className="text-gray-500">Chief Executive Officer</p>
                            </div>
                            <div class="flex p-4 items-center justify-evenly ">
                                <FaFacebook size={30} className='text-blue-600 hover:text-white hover:bg-blue-600 rounded-lg duration-300' />
                                <FaTwitter size={30} className='text-blue-600 hover:text-white hover:bg-blue-600 rounded-lg duration-300' />
                                <FaInstagram size={30} className='text-blue-600 hover:text-white hover:bg-blue-600 rounded-lg duration-300' />
                                <FaLinkedinIn size={30} className='text-blue-600 hover:text-white hover:bg-blue-600 rounded-lg duration-300' />
                            </div>
                        </div>
