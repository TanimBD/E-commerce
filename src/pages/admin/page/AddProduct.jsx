            ...
            <div className=' flex justify-center items-center h-screen'>
                <div className=' bg-gray-800 px-10 py-10 rounded-xl '>
                    ...
                    <div>
                        <input type="text"
                            name='category'
                            className=' bg-gray-600 mb-4 focus:border-sky-500 focus:ring-sky-500 focus:ring-2 px-2 py-2 w-full lg:w-[20em] rounded-lg text-white placeholder:text-gray-200 outline-none'
