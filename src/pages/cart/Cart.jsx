...
function Cart() {
    ...
    const grandTotal = shipping + totalAmount + (totalAmount * 0.05)
    // console.log(grandTotal)


    return (
        <Layout >
            <div className="h-screen bg-gray-100 pt-5 mb-[20%]" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
                <h1 className="mb-10 lg:text-4xl text-center text-2xl font-black leading-9 text-gray-800 dark:text-white">Manage Items</h1>
                <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
                            ...
                            return (<div className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
                                ...
                                <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                                    <div className="mt-5 sm:mt-0">
                                        ...
                                        <p className="mt-1 font-semibold text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>${price}</p>
                                    </div>
                                    <div onClick={() => deleteCart(item)} className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 mt-1 ms-2 cursor-pointer h-6">
                    ...
                    <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
                        ...
                        <hr className="my-4" />
                        <small className='align-end'>Including vat 5%</small>
